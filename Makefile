...
build-api:
	...
	docker --log-level=debug build --pull --file=gateway/docker/production/php-fpm/Dockerfile --tag=${REGISTRY}/auction-api:${IMAGE}
	docker --log-level=debug build --pull --file=gateway/docker/production/php-cli/Dockerfile --tag=${REGISTRY}/auction-api:${IMAGE}
